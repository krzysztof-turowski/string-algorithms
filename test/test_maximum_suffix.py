...
class TestMaximumSuffix(unittest.TestCase):
  ...
  def test_maximum_suffix(self):
    self.check_maximum_suffix('#abaaba', 6, (2, 3))
    self.check_maximum_suffix('#banana', 6, (3, 2))
    self.check_maximum_suffix('#abaaaaaaa', 9, (2, 8))
    self.check_maximum_suffix('#yabbadabbado', 12, (1, 12))
    self.check_maximum_suffix('#aabaabaabba', 11, (9, 3))
    self.check_maximum_suffix('#eembambmaaa', 11, (6, 6))
