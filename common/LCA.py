...
class LCA:
    ...
    def query(self, a, b):
        ...
        if a == b:
            ...
            d = int(math.log2(b - a))
        if self.rmq_array[self.sparse_table[d][a]] > self.rmq_array[self.sparse_table[d][b - 2 ** d]]:
            return self.internal_indexing_reversed[self.rmq_array[self.sparse_table[d][b - 2 ** d]]]
        else:
            return self.internal_indexing_reversed[self.rmq_array[self.sparse_table[d][a]]]
